...
<section class="container_box">
      <div class="row">
          ...
          <p class="text-center" style="font-size: 12px;">'.$site_address.'</p>
          <hr>
        <div class="content_box">
          ...
          <table class="table customTable">
            <tbody>
              ...
              <tr>
                <td>Pengganti</td>
                <td>: '.strip_tags($row['pengganti']).'</td>
              </tr>
            ...
            <table class="table customTable" style="margin-top:10px;">
              <tbody>
                <tr>
                  ...
                  <td class="text-center">Pengganti<p class="name-ttd">'.$row['pengganti'].'</p></td>
