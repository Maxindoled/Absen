  ...
  <section class="content">
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <div style="border-radius: 10px;" class="small-box bg-primary">
            <div class="inner">
        ...
        <div class="col-lg-3 col-xs-6">
          <div style="border-radius: 10px;" class="small-box bg-warning">
            <div class="inner">
        ...
        <div class="col-lg-3 col-xs-6">
          <div style="border-radius: 10px;" class="small-box bg-danger">
            <div class="inner">
        ...
        <div class="col-lg-3 col-xs-6">
          <div style="border-radius: 10px;" class="small-box bg-success">
            <div class="inner">
