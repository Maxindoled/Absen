    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        echo '
          ...
          echo '<a href="./pesan"><i class="fa fa-comment" aria-hidden="true"></i> <span>Pesan Karyawan</span></a></li>';
          ...
          echo '<a href="./setting"><i class="fa fa-cogs" aria-hidden="true"></i> <span>Setting</span></a></li>';
