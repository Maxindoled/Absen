...
?>
  ...
  <?php echo '
<body style="background-image: url(../../sw-content/dds.jpg); background-repeat: no-repeat; 
background-size: cover;" class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
    <a href="./"><img src="../../sw-content/logo.png"  oncontextmenu="return false;" height="50"></a>
  </div>
  <!-- /.login-logo -->
    ...
    <p class="login-box-msg">Silahkan masukkan username dan password</p>
     ...
     <hr>
      ...
      <div class="col-md-12" style="min-height:40px;"><span id="stat"></span></div>
        <div class="col-xs-12">
          <button type="submit" class="btn btn-warning btn-block btn-rounded" id="login">Login</button>
        </div>
        <!-- /.col -->
      </div>
...
<!-- /.login-box -->'; ?>
  ...
  <footer style="color: #FFFFFF;" class="text-muted text-center">
    2023 @ MaxindoLED<a href="https://leonelstudio.com" rel="dofollow" target="_blank"></a><br />
