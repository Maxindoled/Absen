                ...
                <div class="wallet-footer text-center">
                    ...
                    if($mobile =='true'){
                        ...
                        <div class="webcam-camera">
                             <img src="sw-content/selfie.png">';
                             if($result_absent->num_rows > 0){
                                echo'
                                <button class="btn btn-warning btn-lg btn-block"><ion-icon name="camera-outline"></ion-icon>Absen Pulang<input type="file" name="webcam" id="webcam" accept="image/jpg, image/gif, image/jpeg" capture="environment"></button>';}
                                else{
                                echo'
                                <button class="btn btn-warning btn-lg btn-block"><ion-icon name="camera-outline"></ion-icon>Absen Masuk<input type="file" name="webcam" id="webcam" accept="image/jpg, image/gif, image/jpeg" capture="environment"></button>';}
                            echo'
                        </div>';
                    }
                    else{
                        ...
                        <div class="form-group basic">';
                            if($result_absent->num_rows > 0){
                                ...
                                echo'
                                <button class="btn btn-warning btn-lg btn-block" onClick="captureimage(0)"><ion-icon name="camera-outline"></ion-icon>Absen Masuk</button>';}
                        echo'
                        </div>';
                    }
                echo'
