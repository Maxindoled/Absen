  ...
  echo'<!-- App Capsule -->
    ...
    <div class="card-body">
        ...
        <div class="col-sm-4 col-md-4 justify-content-between">
           ...
           <button style="margin-left: 5px; height: 40px; width: 100px;" type="button" class="btn btn-warning mt-1" data-toggle="modal" data-target="#modal-print"><ion-icon name="print-outline"></ion-icon>Print</button>
        </div>
