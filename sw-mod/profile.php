  ...
  echo'<!-- App Capsule -->
    <div id="appCapsule">
        ...
        <div class="section mt-2 mb-2">
            <div class="section-title text-center">Profil</div>
            <div class="card">
                <div class="card-body">
                    <form id="update-profile">
                        ...
                        <hr>
                            <button type="submit" class="btn btn-dark mr-1 btn-lg btn-block btn-profile">Simpan</button>
        ...
        <div class="section mt-2 mb-2">
            <div class="section-title text-center">Update Password</div>
            <div class="card">
                <div class="card-body">
                    <form id="update-password">
                        ...
                        <hr>
                        <button type="submit" class="btn btn-dark mr-1 btn-lg btn-block">Simpan</button>
                    </form>
