...
<div class="row">
  <div class="col-md-3">
    <p>Hadir : <span class="badge badge-warning">'.$hadir->num_rows.'</span></p>
  </div>
  ...
  <div class="col-md-3">
    <p>Sakit : <span class="badge badge-success">'.$sakit->num_rows.'</span></p>
  </div>
    ...
    if($result_cuty->num_rows > 0){
      while ($row_cuty = $result_cuty->fetch_assoc()) {
        if($row_cuty['cuty_status']=='1'){
          $status = '<span class="badge badge-warning">Disetujui</span>';
...
$error = array();
  ...
  if (empty($_POST['pengganti'])) {
    $error[] = 'tidak boleh kosong';
  } else {
    $pengganti = anti_injection($_POST['pengganti']);
  }

  // if (empty($_POST['sisa_cuty'])) {
  //   $error[] = 'tidak boleh kosong';
  // } else {
  //   $sisa_cuty = anti_injection($_POST['sisa_cuty']);
  // }
...
case 'load-home-counter':
  ...
  <div class="col-6 col-md-3 mb-2">
      <a href="javascript:void(0)" class="item">
          <div class="detail">
              <div style="height: 35px; width: 35px; padding-top: 5px" class="rounded icon-block bg-dark text-center">
                <ion-icon class="text-light" style="font-size: small;" name="arrow-forward-circle"></ion-icon>
              </div>
              <div>
                  <strong style="font-size: 12px;">Hadir</strong>
  ...
  <div class="col-6 col-md-3 mb-2">
      <a href="javascript:void(0)" class="item">
          <div class="detail">
              <div style="height: 35px; width: 35px; padding-top: 5px" class="rounded icon-block bg-dark text-center">
                  <ion-icon class="text-light" style="font-size: small;" name="pricetag"></ion-icon>
              </div>
              <div>
                  <strong style="font-size: 12px;">Izin</strong>
  ...
  <div class="col-6 col-md-3">
      <a href="javascript:void(0)" class="item">
          <div class="detail">
              <div style="height: 35px; width: 35px; padding-top: 5px" class="rounded icon-block bg-dark text-center">
                <ion-icon class="text-light" style="font-size: small;" name="bookmark"></ion-icon>
              </div>
              <div>
                  <strong style="font-size: 12px;">Sisa Cuti</strong>
  ...
  <div class="col-6 col-md-3">
      <a href="javascript:void(0)" class="item">
          <div class="detail">
              <div style="height: 35px; width: 35px; padding-top: 5px" class="rounded icon-block bg-dark text-center">
                <ion-icon class="text-light" style="font-size: small;" name="log-in"></ion-icon>
              </div>
              <div>
                  <strong style="font-size: 12px;">Check In</strong>
